...
e verifica se ela é um PALÍNDROMO, isto é, uma palavra que pode ser
lida tanto da frente para trás quanto de trás para frente.
...
# Parte 1: PREEENCHIMENTO DA PILHA
# Pega cada letra da palavra (convertida em maiusculas, para facilitar)
# a posterior comparação) e insere no final (topo) da pilha
...
# Enquanto a pilha não estiver vazia, vamos retirando a última letra dela
# e concatenando-a à variável inverso
inverso = ""
