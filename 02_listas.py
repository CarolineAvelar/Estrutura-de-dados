...
#No exemplo a seguir, vamos dar print() em cada um dos legumes. Após o leg pode ser subtituido por qualquer varivel
# - o que não pode mudar é o nome da lista, o for e o in. for X in Lista
for leg in legumes:
    print(leg)
...
# PARAMENTROS:
#   1º ~> a posição onde sera feita a inserção (a contagem começa em zero)
...
# Cria uma sublista que contém os elementos desde o início até a posição 6
# (posição 7 *NÃO ENTRA*)
sublista_inicio_6 = legumes[:7]
print("Sublista do início à posição 6:", sublista_inicio_6)

# Cria uma sublista que contém os elementos da posição 4 até o final da lista
