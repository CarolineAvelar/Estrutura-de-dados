class Queue:
    ...
    da fila pode ser descrito pelo princípio FIFO
    (First In, First Out): o primeiro a entrar também é o primeiro a sair
    """
    def __init__(self):
        """ Método Construtor """
    ...
    def peek(self):
        ...
        """
        if self.is_empty():
            raise Exception("ERRO: impossível consultar de uma lista vazia")
