class Deque:
    ...
    Deque (Duuble-Ended QUEue) é uma estrutura de dados derivada 
    da fila, permitindo inserções e remoções em qualquer uma de 
    suas extremidades. Com isso, o deque pode se comportar tanto
    como fila, comum quanto como uma fila na qual são admitidas
    ...
    def insert_front(self, val):
        """ Método para inserção no inicio (posição 0) """
    ...
    def peek(self, front = True):
        """
        Método que consulta um elemento do deque dem removê-lo.
        Se o parâmetro 'front' dor True (ou tiver sido omitido),
