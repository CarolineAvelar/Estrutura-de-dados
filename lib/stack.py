class Stack:
    ...
    na qual tanto a operação de inserção(tradicionalmente chamada
    de "push") quanto a operação de remoção ("pop") acontecem no final (ou topo).
    Em consequência, o funcionamento da pilha obedece ao principio lifo
    (Last In, Firts Out): o último elemento a entrar é o primeiro a sair.
    """

    def __init__(self):
        """ Método construtor"""
    # Cria uma pilha privada e vazia para armazenar os elementos da pilha 
        self.__data = []
    ...
    def peek (self):
        ...
        return self.__data[-1]  # Ultimo elemento da pilha
