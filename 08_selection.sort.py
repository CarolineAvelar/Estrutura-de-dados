...
def selection_sort(lista):
    ...
    se necessário. O processo se repete até que o penúltimo elemento da lista seja selecionado,
    ...
    for pos_sel in range(len(lista) - 1):
        ...
        # Inicia a supondo que a posição do menor valor do resto da lista 
        # é o que está imediatamente à frente do valor selecionado.
        pos_menor = pos_sel + 1
        ...
        # Neste ponto, já terminamos de percorrer o restante da lista
        # e sabemos a posição do menor valor que há nele.
        # Comparamos, então, os valores das posiçãoes pos_menor e pos_sel.
        # Se o primeiro for MENOR que o segundo, fazemos a troca entre eles.
